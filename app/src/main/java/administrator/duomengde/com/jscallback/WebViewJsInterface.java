...
public  interface WebViewJsInterface {
    ...
    @JavascriptInterface
    abstract void gallery(String response);
...
//    String getHostsList();
    ...
    class BaseWebViewJsInterface implements WebViewJsInterface {
        ...
        public String replaceAdsParams(String url) {
            return HtmlUtil.replaceAdsUrlParams(BaseApp.getAppContext(), url);
        }
        ...
        public String getDeviceInfo() {
            ...
            Map<String, String> params = HtmlUtil.getAdsParams(BaseApp.getAppContext(), 1);
